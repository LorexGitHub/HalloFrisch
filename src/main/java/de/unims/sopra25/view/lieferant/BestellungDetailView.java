...
/**
 * Abstrakte Klasse, die die Struktur der Szene BestellungsDetailView vorgibt.
 *
 * @author Frederik Fluegge, Johannes Schick
 */
public class BestellungDetailView extends ScrollPane {
    ...
    /**
     * Konstruktor für Detail-View
     *
     * @param bestellung Anzuzeigende Bestellung
     */
